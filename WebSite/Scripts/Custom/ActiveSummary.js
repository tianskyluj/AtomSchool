...
function GetDetail(ID) {
    $.post(
            '/Custom/GetCustomMaintainDetal',                                               // 修改表格名称
            {
            "ID": ID
        },
            function (result) {
                ...
                $('#maintainMethod_detail').html(entity.MaintainMethod.MethodName);
                $('#maintainType_detail').html(entity.MaintainType.TypeName);
                $('#custom_detail').html(entity.Custom.Name);

                var date = new Date(parseInt(entity.MaintainTime.substr(6)));
                $('#maintainTime_detail').html(date.format("yyyy-mm-dd"));

                $('#result_detail').html(entity.Result);
                $("#detail").modal("show");
            }
        );
}