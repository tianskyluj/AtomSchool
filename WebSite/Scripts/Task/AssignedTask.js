...
$(function () {
    ...
    $('.detail').click(function () {
        GetTaskStateWithTask($(this).attr('value'));
    });
...
// 获取任务状态信息
function GetTaskStateWithTask(reveiveID) {
    $.post(
            '/Task/GetTaskStateWithTask',                                               // 修改表格名称
            {
            "ID": reveiveID
        },
            function (result) {
                ...
                $('#taskReceiveState').empty();
                for (i = 0; i < entity.length; i++) {
                    $('#taskReceiveState').append(
                        "<div class='control-group'>" +
                            "<div class='controls'>" +
                               " <span><a href='javascript:void(0)'>任务人:</a>" + entity[i].ReceiveUser.Name + "</span>" +
                           " </div>" +
                            "<div class='controls'>"+
                               " <span><a href='javascript:void(0)'>完成状态:</a>" + entity[i].TaskState.StateName + "</span>" +
                           " </div>"+
                           " <div class='controls'>"+
                                "<span>任务完成百分比: " + entity[i].TaskPercentage + "%</span>" +
                                 "<div class='progress progress-info'>"+
                                    "<div class='bar' style='width: " + entity[i].TaskPercentage + "%'></div>" +
                               " </div>"+  
                           " </div>"+
                        "</div>"
                    );
