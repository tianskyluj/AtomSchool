...
<body>
            ...
            <div class="social-box">
                ...
                <div class="body">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered"
                        ...
                        <tbody>
                            <% foreach (var item in (this.ViewData["Task"] as IEnumerable<Domain.Task>).OrderByDescending(f => f.SendTime))
                               { %>
                            <tr class="gradeX">
                                <td>
    ...
    <aside id="detail" class="modal hide fade" tabindex="-1" role="dialog"
        ...
        <div class="modal-header">
            ...
            <h3 id="roleAddOrUpdateTitle"><span id="Span5">查看任务状态</span></h3>
        </div>
        <div class="modal-body" id="taskReceiveState">
