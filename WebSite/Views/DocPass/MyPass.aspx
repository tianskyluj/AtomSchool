            ...
            <div class="social-box">
                ...
                <div class="body">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered"
                        ...
                        <tbody>
                            <% foreach (var item in (this.ViewData["ReceiveUserRelation"] as IEnumerable<Domain.DocReceiveUserRelation>).OrderByDescending(f => f.DocPass.CreateTime))
                               { %>
                            <tr class="gradeX">
                                <td>
                                ...
                                <td>
                                    <a class="btn btn-mini detail" href="javascript:void(0)" value='<%= item.DocPass.ID%>'>
